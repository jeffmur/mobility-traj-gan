# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 11:00:38 2021
...
# for gamma in [2]:
    ...
    print(gamma)
    model_name = 'Gamma('+str(gamma)+')-Optim('+opt_name+')-BatchSize('+str(batch_size)+')'
    ...
    plot_model(model, to_file='model1.png', show_shapes=True, show_layer_names=True, rankdir='LR', dpi=200)
